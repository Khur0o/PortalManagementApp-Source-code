...
public class GuidanceCouncilActivity extends AppCompatActivity implements SearchView.OnQueryTextListener, NavigationView.OnNavigationItemSelectedListener{
    ...
    private AccountDataAdapter4 data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guidance_council);
        ...
        //ref = FirebaseDatabase.getInstance().getReference("AdminAccess").child("StudentList");

        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        list = new ArrayList<>();
        data = new AccountDataAdapter4(this, list);
    ...
    public boolean onQueryTextSubmit(String query) {
        // No need to implement this since we want to filter the results in real-time
        return false;
    }
