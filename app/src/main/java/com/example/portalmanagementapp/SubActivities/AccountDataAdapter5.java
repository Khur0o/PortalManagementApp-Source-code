...
public class AccountDataAdapter5 extends RecyclerView.Adapter<AccountDataAdapter5.ViewHolder> {

    private Context context;
    private List<AccountDataInformation> originalList;
    private List<AccountDataInformation> filteredList;

    public AccountDataAdapter5(Context context, List<AccountDataInformation> list) {
