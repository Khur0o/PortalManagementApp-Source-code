...
public class AccountDataAdapter3 extends RecyclerView.Adapter<AccountDataAdapter3.ViewHolder> {

    private Context context;
    private List<AccountDataInformation> originalList;
    private List<AccountDataInformation> filteredList;

    public AccountDataAdapter3(Context context, List<AccountDataInformation> list) {
