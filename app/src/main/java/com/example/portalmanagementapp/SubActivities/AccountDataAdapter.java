...
public class AccountDataAdapter extends RecyclerView.Adapter<AccountDataAdapter.ViewHolder> {

    private Context context;
    private List<AccountDataInformation> originalList;
    private List<AccountDataInformation> filteredList;

    public AccountDataAdapter(Context context, List<AccountDataInformation> list) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            Data.setOnClickListener(view -> {
                ...
                popup.getMenuInflater().inflate(R.menu.account, popup.getMenu());
