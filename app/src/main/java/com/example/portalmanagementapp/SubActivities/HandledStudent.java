...
public class HandledStudent extends AppCompatActivity implements SearchView.OnQueryTextListener, NavigationView.OnNavigationItemSelectedListener{
    ...
    private ArrayList<StudentInformation> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_handled_student);
        ...
        list = new ArrayList<>();
        data = new DataAdapter4(this, list);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    StudentInformation update = dataSnapshot.getValue(StudentInformation.class);
                    if (update != null && (update.getFullname().toLowerCase().contains(searchText) || update.getStudentNumber().toLowerCase().contains(searchText))) {
                        list.add(update);
                    }
                }
