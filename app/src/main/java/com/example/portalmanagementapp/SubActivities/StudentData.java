...
public class StudentData extends AppCompatActivity implements SearchView.OnQueryTextListener, NavigationView.OnNavigationItemSelectedListener{
    ...
    private AccountDataAdapter3 data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        data = new AccountDataAdapter3(this, list);
