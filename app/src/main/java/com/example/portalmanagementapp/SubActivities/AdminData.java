...
public class AdminData extends AppCompatActivity implements SearchView.OnQueryTextListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    private AccountDataAdapter data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        data = new AccountDataAdapter(this, list);
        ...
        Admin.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    ...
                    if (update != null && (update.getName().toLowerCase().contains(searchText) || update.getUserID().toLowerCase().contains(searchText))) {
                        list.add(update);
                    }
                }
